    ...
    <div class="card ">
        <div class="card-body">
            ...
            <?php if (isset($_SESSION['last_name'])) { ?>
                ...
                <div class="actions">
                    <a href="./updateAgents.php?id=<?= $agent->getAgent_id_uuid() ?>"><img src="https://img.icons8.com/external-kiranshastry-solid-kiranshastry/30/000000/external-edit-interface-kiranshastry-solid-kiranshastry-2.png" /></a>
                    <a onclick="deleteAjax('<?= $agent->getAgent_id_uuid(); ?>', '<?= $agent->getIdentification_code() ?>', './deleteAgents.php')"><img src="https://img.icons8.com/ios-glyphs/30/000000/filled-trash.png" /></a>
                </div>
            <?php
            }
            ?>
