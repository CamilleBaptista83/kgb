    ...
    <div class="card">
        <div class="card-body">
            ...
            <?php if (isset($_SESSION['last_name'])) { ?>
                ...
                <div class="actions">
                    <a href="../actions/contacts/updateContact.php?id=<?= $contact->getAgent_id_uuid() ?>"><img src="https://img.icons8.com/external-kiranshastry-solid-kiranshastry/30/000000/external-edit-interface-kiranshastry-solid-kiranshastry-2.png" /></a>
