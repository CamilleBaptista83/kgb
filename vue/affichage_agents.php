<div class="col-6 col-sm-4 col-md-3 p-2">
    <div class="card " style="width: 18rem; height:25rem">
        <div class="card-body">
            ...
            <a href="../actions/agents/deleteAgents.php?id=<?= $agent->getAgent_id_uuid() ?>" ><img src="https://img.icons8.com/ios-glyphs/30/000000/filled-trash.png"/></a>

            <?php
            if (isset($_GET['id'])) {
            ?>
                <a href="../actions/agents/deleteAgents.php?id=<?= $agent->getAgent_id_uuid() ?>" class="btn btn-danger">Supprimer l'agent de la mission</a>
            <?php
            }
            ?>
