<div class="col-6 col-sm-4 col-md-3 p-2" id="delete<?= $cible->getCode_name() ?>">
    <div class="card">
        <div class="card-body">
            ...
            ?>
                <div class="actions">
                    <a href="./updateCibles.php?id=<?= $cible->getTarget_id_uuid() ?>"><img src="https://img.icons8.com/external-kiranshastry-solid-kiranshastry/30/000000/external-edit-interface-kiranshastry-solid-kiranshastry-2.png" /></a>
                    <a onclick="deleteAjax('<?= $cible->getTarget_id_uuid(); ?>', '<?= $cible->getCode_name() ?>', './cibles/deleteCibles.php')"><img src="https://img.icons8.com/ios-glyphs/30/000000/filled-trash.png" /></a>
                </div>
            <?php
            }
            ?>
